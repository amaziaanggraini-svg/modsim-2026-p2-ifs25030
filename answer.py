...
# --- PERBAIKAN Q7 & Q8 ---
    ...
    # Menghitung jumlah 'TS' per kolom
    counts = (data_q == 'TS').sum()
    # Mencari kolom dengan jumlah 'TS' terbanyak
    q_id = counts.idxmax()
    # Menghitung persentase berdasarkan total responden
    pct = (counts[q_id] / n_partisipan) * 100
    # Output sesuai format yang diminta: Kolom|8|Persen
